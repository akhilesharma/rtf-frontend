        ...
        <div className='container-fluid'>
            <div className='row'>
                ...
                <div className='col-xl-10 col-lg-9 col-md-8 col-sm-6 col-12'>
                    <h5 className='background text-light text-center p-2'>Product Update Page </h5>
                    <form onSubmit={postData}>
                        ...
                        <div className='row mb-3'>
                            <div className="col-sm-6 col-12">
                                ...
                                <input type="number" min={0} className="form-control" name='baseprice' onChange={getData} placeholder="Enter Product BasePrice" value={product.baseprice} />
                            </div>
                            <div className="col-sm-6 col-12">
                                <label className="form-label">Discount</label>
                                <input type="number" min={0} className="form-control" name='discount' onChange={getData} placeholder="Enter Discount On Product" value={product.discount} />
                            </div>
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            ...
                            <textarea type="text" className="form-control" name='description' onChange={getData} placeholder="Enter Product Description" rows={5} value={product.description} />
                        </div>
                        <div className='row mb-3'>
                            <div className="col-md-3 col-sm-6 col-12">
